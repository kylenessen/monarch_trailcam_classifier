...
This release makes the study classifier available as a documented desktop application. It includes an example deployment, a safe conversion tool for archived annotations, and automated checks for opening, saving and reopening a deployment. Copy Previous is now disabled on the first image.

The runtime and build tools are updated to Electron 44.4.5, electron-builder 26.15.3 and Playwright 1.63.0. The dependency audit reports no known vulnerabilities at release preparation. This does not guarantee the absence of software defects.
