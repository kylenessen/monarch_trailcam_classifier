...
Night photos can be challenging to classify due to the trail camera's flash. While butterflies may be harder to see at night, our observations suggest that monarchs remain stationary during nighttime hours. You can typically use the `S` key or the "Copy Previous" button to copy classifications from the previous image.
